    ...
    S::Error: Into<execution::Error>,
{
    ...
    pub fn commit_upgrade(
        ...
        migrate_withdraw_to_unbonding::<S>(&tracking_copy, correlation_id, auction_hash)?;
    ...
    S::Error: Into<execution::Error>,
{
    ...
    // println!("all withdraw keys {}", withdraw_keys.len());
    ...
    for key in withdraw_keys {
        ...
        // migrated.
        fail_upgrade_if_withdraw_purses_lack_sufficient_balance::<S>(
            &withdraw_purses,
            tracking_copy,
            correlation_id,
        )?;
...
fn fail_upgrade_if_withdraw_purses_lack_sufficient_balance<S>(
