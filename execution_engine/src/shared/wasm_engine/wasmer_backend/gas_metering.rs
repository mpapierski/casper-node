...
fn cost_function(opcode_costs: OpcodeCosts, operator: &Operator) -> u64 {
    let instruction_type = match operator {
        ...
        // wasmer middleware.
        Operator::Try { ty: _ } => todo!(),
        Operator::Catch { index: _ } => todo!(),
        Operator::Throw { index: _ } => todo!(),
        Operator::Rethrow { relative_depth: _ } => todo!(),
        Operator::ReturnCall { function_index: _ } => todo!(),
        ...
        Operator::MemoryInit { segment, mem: _ } => todo!(),
        Operator::DataDrop { segment: _ } => todo!(),
        Operator::MemoryCopy { src, dst: _ } => todo!(),
        Operator::MemoryFill { mem: _ } => todo!(),
        Operator::TableInit { segment, table: _ } => todo!(),
        Operator::ElemDrop { segment: _ } => todo!(),
        Operator::TableCopy {
            dst_table: _,
            src_table: _,
        } => todo!(),
        ...
        Operator::AtomicFence { flags: _ } => todo!(),
