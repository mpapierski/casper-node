...
fn cost_function(opcode_costs: OpcodeCosts, operator: &Operator) -> u64 {
    let instruction_type = match operator {
        ...
        // NOTEL: Those are unsupported proposals. These opcodes should be disabled by another wasmer middleware.
    ...
    let cost = match instruction_type {
        ...
        InstructionType::FloatConst => todo!("opcode_costs.float_const"),
        ...
        InstructionType::FloatComparison => todo!("opcode_costs.float_comparison"),
        InstructionType::Float => todo!("opcode_costs.float"),
        InstructionType::Conversion => opcode_costs.conversion,
        InstructionType::FloatConversion => todo!("opcode_costs.float_conversion"),
...
mod tests {
    ...
    fn should_create_metering_middleware() {
        let _middleware = super::wasmer_metering(u64::MAX, OpcodeCosts::default());
    }
}
