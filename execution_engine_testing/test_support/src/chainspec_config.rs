...
pub static PRODUCTION_CHAINSPEC: Lazy<ChainspecConfig> = Lazy::new(|| {
    ChainspecConfig::from_chainspec_path(&*PRODUCTION_PATH)
        .expect("should load production chainspec")
});
