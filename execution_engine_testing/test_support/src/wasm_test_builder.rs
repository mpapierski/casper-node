...
impl InMemoryWasmTestBuilder {
    ...
    pub fn new_with_chainspec<P: AsRef<Path>>(
        ...
        let engine_config = engine_config_builder_from_chainspec(chainspec_config).build();
...
fn engine_config_builder_from_chainspec(chainspec: ChainspecConfig) -> EngineConfigBuilder {
    let vesting_schedule_period_millis = chainspec
        .core_config
        .vesting_schedule_period
        .as_millis()
        .try_into()
        .expect("vesting_schedule_period should fit in u64");
