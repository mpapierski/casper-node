...
fn should_verify_isolated_auction_storage_is_free() {
    use casper_engine_test_support::instrumented;
...
fn should_measure_gas_cost_for_storage_usage_write() {
    ...
    builder
        .exec_instrumented(instrumented!(install_exec_request))
        .expect_success()
        .commit();
    ...
    let small_write_function_cost = {
        ...
        builder_a
            .exec_instrumented(instrumented!(small_write_exec_request))
            .expect_success()
            .commit();
    ...
    let large_write_function_cost = {
        ...
        builder_b
            .exec_instrumented(instrumented!(large_write_exec_request))
            .expect_success()
            .commit();
...
fn should_measure_gas_cost_for_storage_usage_add() {
    ...
    let small_add_function_cost = {
        ...
        builder_a
            .exec_instrumented(instrumented!(small_add_exec_request))
            .expect_success()
            .commit();
