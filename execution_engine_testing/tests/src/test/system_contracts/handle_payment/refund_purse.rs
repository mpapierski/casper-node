...
fn refund_tests(builder: &mut InMemoryWasmTestBuilder, account_hash: AccountHash) {
    ...
    builder
        .exec_instrumented(instrumented!(create_purse_request_1))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(create_purse_request_2))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(refund_purse_request))
        .expect_success()
        .commit();
}
