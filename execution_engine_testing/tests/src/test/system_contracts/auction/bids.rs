...
fn should_decrease_existing_bid() {
    ...
    .build();
    builder
        .exec_instrumented(instrumented!(bid_request))
        .expect_success()
        .commit();
    ...
    .build();
    builder
        .exec_instrumented(instrumented!(withdraw_request))
        .commit()
        .expect_success();
...
fn should_run_delegate_and_undelegate() {
    ...
    builder
        .exec_instrumented(instrumented!(transfer_request_1))
        .commit()
        .expect_success();
    builder
        .exec_instrumented(instrumented!(transfer_request_2))
        .commit()
        .expect_success();
    builder
        .exec_instrumented(instrumented!(add_bid_request_1))
        .commit()
        .expect_success();
...
fn should_release_founder_stake() {
    ...
    builder
        .exec_instrumented(instrumented!(fund_system_account))
        .commit()
        .expect_success();
...
fn should_calculate_era_validators_multiple_new_bids() {
    ...
    builder
        ...
        .expect_success();
    builder
        .exec_instrumented(instrumented!(add_bid_request_2))
        .commit()
        .expect_success();
...
fn undelegated_funds_should_be_released() {
    ...
    builder
        .exec_instrumented(instrumented!(delegator_1_undelegate_request))
        .commit()
        .expect_success();
...
fn should_undelegate_delegators_when_validator_unbonds() {
    ...
    builder
        .exec_instrumented(instrumented!(validator_1_withdraw_bid))
        .commit()
        .expect_success();
...
fn should_handle_evictions() {
    ...
    builder
        .exec_instrumented(instrumented!(system_fund_request))
        .commit()
        .expect_success();
...
fn should_not_partially_undelegate_uninitialized_vesting_schedule() {
    ...
    .build();
    builder
        .exec_instrumented(instrumented!(fund_delegator_account))
        .commit()
        .expect_success();
    ...
    builder
        .exec_instrumented(instrumented!(partial_undelegate))
        .commit();
    let error = {
        let response = builder
            .get_last_exec_results()
...
fn should_not_undelegate_vfta_holder_stake() {
    ...
    for post_genesis_request in post_genesis_requests {
        builder
            .exec_instrumented(instrumented!(post_genesis_request))
            .commit()
            .expect_success();
    }
...
fn should_reset_delegators_stake_after_slashing() {
    ...
    builder
        .exec_instrumented(instrumented!(slash_request_1))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(slash_request_2))
        .expect_success()
        .commit();
...
fn should_delegate_and_redelegate() {
    ...
    builder
        .exec_instrumented(instrumented!(delegator_1_redelegate_request))
        .commit()
        .expect_success();
...
fn should_handle_redelegation_to_inactive_validator() {
    ...
    builder
        .exec_instrumented(instrumented!(invalid_redelegate_request))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(valid_redelegate_request))
        .expect_success()
        .commit();
