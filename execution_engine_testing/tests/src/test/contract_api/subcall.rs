...
fn should_charge_gas_for_subcall() {
    ...
    builder
        .exec_instrumented(instrumented!(do_nothing_request))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(do_something_request))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(no_subcall_request))
        .expect_success()
        .commit();
...
fn should_add_all_gas_for_subcall() {
    ...
    builder
        .exec_instrumented(instrumented!(add_zero_gas_from_session_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(add_some_gas_from_session_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(add_zero_gas_via_subcall_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(add_some_gas_via_subcall_request))
        .expect_success()
        .commit();
...
fn expensive_subcall_should_cost_more() {
    ...
    builder
        .exec_instrumented(instrumented!(store_do_nothing_request))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(store_calculation_request))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(call_do_nothing_request))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(call_expensive_calculation_request))
        .expect_success()
        .commit();
