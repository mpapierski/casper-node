...
fn should_fail_to_add_into_existing_bid_over_the_approved_amount() {
    ...
    builder
        .exec_instrumented(instrumented!(validator_1_add_bid_request_1))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(validator_1_add_bid_request_2))
        .expect_failure();
...
fn should_fail_to_add_new_delegator_over_the_approved_amount() {
    ...
    builder
        .exec_instrumented(instrumented!(delegator_1_delegate_requestr))
        .expect_failure()
        .commit();
...
fn should_fail_to_update_existing_delegator_over_the_approved_amount() {
    ...
    builder
        .exec_instrumented(instrumented!(delegator_1_delegate_request_1))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(delegator_1_delegate_request_2))
        .expect_failure()
        .commit();
