...
fn setup() -> InMemoryWasmTestBuilder {
    ...
    builder
        .exec_instrumented(instrumented!(fund_account_1_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(fund_purse_1_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(fund_purse_2_request))
        .expect_success()
        .commit();
    builder
        .exec_instrumented(instrumented!(fund_purse_3_request))
        .expect_success()
        .commit();
    builder
}
