...
fn should_run_ee_1119_dont_slash_delegated_validators() {
    ...
    builder
        .exec_instrumented(instrumented!(fund_system_exec_request))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(delegate_exec_request))
        .expect_success()
        .commit();
    ...
    .build();
    builder
        .exec_instrumented(instrumented!(undelegate_exec_request))
        .commit()
        .expect_success();
