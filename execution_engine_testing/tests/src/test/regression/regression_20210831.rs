...
fn setup() -> InMemoryWasmTestBuilder {
    ...
    builder
        .exec_instrumented(instrumented!(install_request_1))
        .expect_success()
        .commit();
...
fn regression_20210831_should_fail_to_add_bid() {
    ...
    builder.exec_instrumented(instrumented!(add_bid_request_1));
...
fn regression_20210831_should_fail_to_delegate() {
    ...
    builder.exec_instrumented(instrumented!(delegate_request_1));
    ...
    builder
        .exec_instrumented(instrumented!(delegate_request_2))
        .commit();
...
fn regression_20210831_should_fail_to_activate_bid() {
    ...
    builder.exec_instrumented(instrumented!(activate_bid_request_1));
    ...
    builder
        .exec_instrumented(instrumented!(activate_bid_request_2))
        .commit();
