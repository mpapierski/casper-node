...
fn should_run_ee_1120_slash_delegators() {
    ...
    builder
        .exec_instrumented(instrumented!(delegate_exec_request_1))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(delegate_exec_request_2))
        .expect_success()
        .commit();

    builder
        .exec_instrumented(instrumented!(delegate_exec_request_3))
        .expect_success()
        .commit();
    ...
    builder
        .exec_instrumented(instrumented!(undelegate_request_1))
        .commit()
        .expect_success();
    builder
        .exec_instrumented(instrumented!(undelegate_request_2))
        .commit()
        .expect_success();
    builder
        .exec_instrumented(instrumented!(undelegate_request_3))
        .commit()
        .expect_success();
